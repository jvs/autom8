...
class TestContext(unittest.TestCase):
    def test_is_training_property(self):
        ...
        c1 = autom8.create_training_context(report.matrix, [], [], 'regression')
        c2 = autom8.create_predicting_context(report.matrix)
...
class TestTrainingContext(unittest.TestCase):
    def test_training_and_testing_data(self):
        ...
        ctx = autom8.create_training_context(report.matrix, labels, [1, 3], 'regression')
